...
**1411**<!--count:test_methods--> test methods ·
...
|---|---|---|---|---|
| Static gates | flake8 · pylint-odoo (baseline **57**<!--count:pylint_baseline-->) · xmllint · shellcheck · `architecture_guard.py` · `invariants.py` (**14**<!--count:invariants_rules--> rules) · `check_role_matrix.py` · `check_skips.py` · AI-gateway satellite | **12 steps** across the `lint` and `architecture-guard` jobs | pre-push (9 gates) + PR | 8s¹ |
